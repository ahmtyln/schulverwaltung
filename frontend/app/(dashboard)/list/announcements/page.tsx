...
import { fetchAnnouncements, fetchMe, getStudentDisplayName, type AnnouncementListItem, type MeDto } from '@/lib/api';
    ...
    <div className="bg-white p-4 rounded-md flex-1">
      ...
      <div className="flex items-center justify-between">
        <h1 className="hidden md:block text-lg font-semibold">
          {isStudent ? 'My Announcements' : isParent ? (selectedChildId ? `Announcements (${getStudentDisplayName(me, selectedChildId)})` : 'Announcements') : 'All Announcements'}
        </h1>
